...
var _rtfeldman$elm_workshop$Auth$token = '97617cfeff393c051d22132cc19b7ebfb6f4ffe7';
...
var _rtfeldman$elm_workshop$Main$searchFeed = function (query) {
	...
	var request = A2(_elm_lang$http$Http$get, url, _rtfeldman$elm_workshop$Main$responseDecoder);
	return A2(_elm_lang$http$Http$send, _rtfeldman$elm_workshop$Main$HandleSearchResponse, request);
};
		...
		switch (_p1.ctor) {
				...
				if (_p2.ctor === 'Ok') {
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								errorMessage: _elm_lang$core$Maybe$Just(errorMessage)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
			...
			default:
				var newResults = A2(
					...
					function (_p4) {
						var _p5 = _p4;
						return !_elm_lang$core$Native_Utils.eq(_p5.id, _p1._0);
					},
					model.results);
				...
				_1: {
					...
					_0: A2(
						_elm_lang$html$Html$button,
						{
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(_rtfeldman$elm_workshop$Main$Search),
								_1: {ctor: '[]'}
							}
						},
						{
					...
					_1: {
						ctor: '::',
						_0: _rtfeldman$elm_workshop$Main$viewErrorMessage(model.errorMessage),
						_1: {
							ctor: '::',
							_0: A2(
